                ...
                <div className="about-grid">
                    <div className="about-visual reveal-slide-left">
                        <div className="about-image-wrapper">
                            ...
                            <img src="/img/image.png" alt="Arquitetura Minimalista" className="about-img-diptych" />
                        </div>
                    </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full text-left">
                                <div className="feature-item-minimal">
                                    ...
                                    <div className="feature-text-block">
                                        ...
                                        <p className="font-sans font-light leading-relaxed text-text-dark text-sm">O aconchego e o carinho de um espaço intimista, somados ao nível técnico de profissionais de grandes salões.</p>
                                    </div>
                                </div>
                                <div className="feature-item-minimal">
                                    <span className="feature-roman font-serif italic text-accent-brass">II.</span>
                                    <div className="feature-text-block">
                                        <h4 className="feature-title font-serif text-lg font-semibold" style={{ textTransform: 'none', letterSpacing: 'normal' }}>Cuidado Humanizado</h4>
                                        <p className="font-sans font-light leading-relaxed text-text-dark text-sm">Uma experiência que abraça. Desde a recepção com mimos exclusivos e bebidas selecionadas, até o toque final do seu atendimento.</p>
                                    </div>
                                </div>
                                <div className="feature-item-minimal">
                                    <span className="feature-roman font-serif italic text-accent-brass">III.</span>
                                    <div className="feature-text-block">
                                        <h4 className="feature-title font-serif text-lg font-semibold" style={{ textTransform: 'none', letterSpacing: 'normal' }}>Especialistas de Elite</h4>
                                        <p className="font-sans font-light leading-relaxed text-text-dark text-sm">Um time de alto calibre em constante atualização para trazer as técnicas e tendências globais diretamente para você.</p>
                                    </div>
                                </div>
                                <div className="feature-item-minimal">
                                    <span className="feature-roman font-serif italic text-accent-brass">IV.</span>
                                    <div className="feature-text-block">
                                        <h4 className="feature-title font-serif text-lg font-semibold" style={{ textTransform: 'none', letterSpacing: 'normal' }}>Foco na Autenticidade</h4>
                                        <p className="font-sans font-light leading-relaxed text-text-dark text-sm">Nosso objetivo não é transformar quem você é, mas realçar os seus melhores traços com resultados harmônicos e elegantes.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
