                ...
                <div className="about-grid">
                    <div className="about-visual reveal-slide-left">
                        <div className="about-image-wrapper">
                            ...
                            <img loading="lazy" src="/img/small_image-opt.webp" alt="Arquitetura Minimalista" className="about-img-diptych" />
                        </div>
                    </div>
                    
                    <div className="about-text-content reveal-slide-right text-left">
                        <p className="about-desc font-sans font-light leading-relaxed  text-base">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full text-left">
                                <div className="feature-item-minimal">
                                    ...
                                    <div className="feature-text-block">
                                        ...
                                        <p className="font-sans font-light leading-relaxed  text-sm">O aconchego e o carinho de um espaço intimista, somados ao nível técnico de profissionais de grandes salões.</p>
                                    </div>
                                </div>
                                <div className="feature-item-minimal">
                                    ...
                                    <div className="feature-text-block">
                                        ...
                                        <p className="font-sans font-light leading-relaxed  text-sm">Uma experiência que abraça. Desde a recepção com mimos exclusivos e bebidas selecionadas, até o toque final do seu atendimento.</p>
                                    </div>
                                </div>
                                <div className="feature-item-minimal">
                                    ...
                                    <div className="feature-text-block">
                                        ...
                                        <p className="font-sans font-light leading-relaxed  text-sm">Um time de alto calibre em constante atualização para trazer as técnicas e tendências globais diretamente para você.</p>
                                    </div>
                                </div>
                                <div className="feature-item-minimal">
                                    ...
                                    <div className="feature-text-block">
                                        ...
                                        <p className="font-sans font-light leading-relaxed  text-sm">Nosso objetivo não é transformar quem você é, mas realçar os seus melhores traços com resultados harmônicos e elegantes.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
