        ...
        <section id="services" className="services-section px-6" style={{ paddingTop: '100px', paddingBottom: '100px' }}>
            ...
            <div className="container">
                <div className="text-center-heading">
                    ...
                    <p className="section-subtitle font-sans font-light leading-relaxed text-neutral-900 text-base">Escolha uma categoria para explorar os cuidados e expertise do nosso salão.</p>
                </div>
                        ...
                        <div className={`tab-panel ${activeTab === 'cabelo' ? 'active' : ''}`} role="tabpanel">
                            <div className="panel-grid">
                                <div className="panel-text">
                                    ...
                                    <p className="panel-desc font-sans font-light leading-relaxed text-neutral-900 text-base">Oferecemos cortes de alta precisão baseados em visagismo, além de colorações íntegras e mechas artísticas criadas sob medida para o seu estilo.</p>
                                        ...
                                        <li className="flex items-center gap-4">
                                            ...
                                            <div className="flex-1">
                                                <div className="service-menu-item flex-1">
                                                    ...
                                                    <span className="service-price font-sans font-medium text-neutral-900">a partir de R$ 189,00</span>
                                                </div>
                                            </div>
                                        </li>
                                        <li className="flex items-center gap-4">
                                            ...
                                            <div className="flex-1">
                                                <div className="service-menu-item flex-1">
                                                    ...
                                                    <span className="service-price font-sans font-medium text-neutral-900">R$ 100,00</span>
                                                </div>
                                            </div>
                                        </li>
                                        <li className="flex items-center gap-4">
                                            ...
                                            <div className="flex-1">
                                                <div className="service-menu-item flex-1">
                                                    ...
                                                    <span className="service-price font-sans font-medium text-neutral-900">a partir de R$ 88,00</span>
                                                </div>
                                            </div>
                                        </li>
                                        <li className="flex items-center gap-4">
                                            ...
                                            <div className="flex-1">
                                                <div className="service-menu-item flex-1">
                                                    ...
                                                    <span className="service-price font-sans font-medium text-neutral-900">a partir de R$ 120,00</span>
                                                </div>
                                            </div>
                                        </li>
                                        <li className="flex items-center gap-4">
                                            ...
                                            <div className="flex-1">
                                                <div className="service-menu-item flex-1">
                                                    ...
                                                    <span className="service-price font-sans font-medium text-neutral-900">a partir de R$ 490,00</span>
                                                </div>
                                            </div>
                                        </li>
                                        <li className="flex items-center gap-4">
                                            ...
                                            <div className="flex-1">
                                                <div className="service-menu-item flex-1">
                                                    ...
                                                    <span className="service-price font-sans font-medium text-neutral-900">a partir de R$ 250,00</span>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
                        ...
                        <div className={`tab-panel ${activeTab === 'unhas' ? 'active' : ''}`} role="tabpanel">
                            <div className="panel-grid">
                                <div className="panel-text">
                                    ...
                                    <p className="panel-desc font-sans font-light leading-relaxed text-neutral-900 text-base">Especialistas em alongamento em gel de altíssima durabilidade, com técnicas modernas que cuidam e respeitam a estrutura natural das unhas.</p>
                                    ...
                                    <ul className="service-menu-list">
                                        <li className="flex items-center gap-4">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <p className="service-details font-sans font-light leading-relaxed text-neutral-900 text-sm mt-1">Acabamento impecável e alta durabilidade.</p>
                                            </div>
                                        </li>
                                        <li className="flex items-center gap-4">
                                            ...
                                            <div className="flex-1">
                                                <div className="service-menu-item flex-1">
                                                    ...
                                                    <span className="service-price font-sans font-medium text-neutral-900">a partir de R$ 180,00</span>
                                                </div>
                                                <p className="service-details font-sans font-light leading-relaxed text-neutral-900 text-sm mt-1">Resistência extrema com aspecto fino e natural.</p>
                                            </div>
                                        </li>
                                        <li className="flex items-center gap-4">
                                            ...
                                            <div className="flex-1">
                                                <div className="service-menu-item flex-1">
                                                    ...
                                                    <span className="service-price font-sans font-medium text-neutral-900">R$ 48,00</span>
                                                </div>
                                                <p className="service-details font-sans font-light leading-relaxed text-neutral-900 text-sm mt-1">Cuidados clássicos para os pés.</p>
                                            </div>
                                        </li>
                                        <li className="flex items-center gap-4">
                                            ...
                                            <div className="flex-1">
                                                <div className="service-menu-item flex-1">
                                                    ...
                                                    <span className="service-price font-sans font-medium text-neutral-900">R$ 45,00</span>
                                                </div>
                                                <p className="service-details font-sans font-light leading-relaxed text-neutral-900 text-sm mt-1">Cutilagem perfeita e esmaltação premium.</p>
                                            </div>
                                        </li>
                                        <li className="flex items-center gap-4">
                                            ...
                                            <div className="flex-1">
                                                <div className="service-menu-item flex-1">
                                                    ...
                                                    <span className="service-price font-sans font-medium text-neutral-900">R$ 83,00</span>
                                                </div>
                                                <p className="service-details font-sans font-light leading-relaxed text-neutral-900 text-sm mt-1">Unindo dois serviços com valor especial.</p>
                                            </div>
                                        </li>
                                        <li className="flex items-center gap-4">
                                            ...
                                            <div className="flex-1">
                                                <div className="service-menu-item flex-1">
                                                    ...
                                                    <span className="service-price font-sans font-medium text-neutral-900">R$ 30,00</span>
                                                </div>
                                                <p className="service-details font-sans font-light leading-relaxed text-neutral-900 text-sm mt-1">Hidratação profunda e esfoliação.</p>
                                            </div>
                                        </li>
                                        <li className="flex items-center gap-4">
                                            ...
                                            <div className="flex-1">
                                                <div className="service-menu-item flex-1">
                                                    ...
                                                    <span className="service-price font-sans font-medium text-neutral-900">R$ 130,00</span>
                                                </div>
                                                <p className="service-details font-sans font-light leading-relaxed text-neutral-900 text-sm mt-1">Remoção de calosidades, rachaduras e hidratação especial.</p>
                                            </div>
                                        </li>
                                    </ul>
                        ...
                        <div className={`tab-panel ${activeTab === 'make' ? 'active' : ''}`} role="tabpanel">
                            <div className="panel-grid">
                                <div className="panel-text">
                                    ...
                                    <p className="panel-desc font-sans font-light leading-relaxed text-neutral-900 text-base">Oferecemos maquiagens sofisticadas de altíssima fixação e tratamentos delicados para harmonização e curvatura dos seus cílios e sobrancelhas.</p>
                                        ...
                                        <li className="flex items-center gap-4">
                                            ...
                                            <div className="flex-1">
                                                <div className="service-menu-item flex-1">
                                                    ...
                                                    <span className="service-price font-sans font-medium text-neutral-900">a partir de R$ 150,00</span>
                                                </div>
                                            </div>
                                        </li>
                                        <li className="flex items-center gap-4">
                                            ...
                                            <div className="flex-1">
                                                <div className="service-menu-item flex-1">
                                                    ...
                                                    <span className="service-price font-sans font-medium text-neutral-900">a partir de R$ 45,00</span>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
