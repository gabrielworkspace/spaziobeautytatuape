                ...
                <div className="booking-grid">
                    ...
                    <div className="booking-info-panel reveal-slide-left">
                        ...
                        <div className="booking-steps-list">
                            <div className="step-card">
                                ...
                                <div>
                                    <h4 className="font-serif text-xl font-semibold">Escolha o Ritual</h4>
                            ...
                            <div className="step-card">
                                ...
                                <div>
                                    <h4 className="font-serif text-xl font-semibold">Verifique a Mensagem</h4>
                    ...
                    <div className="booking-quiz-panel reveal-slide-right" id="bookingQuiz">
                        <div className="quiz-header">
                            <h3 className="font-sans font-medium uppercase tracking-wider text-sm text-text-dark">
                        ...
                        <form onSubmit={(e) => e.preventDefault()}>
                            ...
                            {step === 2 && (
                                <div className="quiz-step active">
                                    <h4 className="quiz-step-title font-serif text-2xl font-semibold text-text-dark">2. Qual o seu dia da semana preferido?</h4>
                                    <div className="quiz-options-grid">
                            ...
                            {step === 3 && (
                                <div className="quiz-step active">
                                    <h4 className="quiz-step-title font-serif text-2xl font-semibold text-text-dark">3. Conte-nos quem é você</h4>
                            ...
                            {step === 4 && (
                                <div className="quiz-step active">
                                    <h4 className="quiz-step-title text-center font-serif text-2xl font-semibold text-text-dark"><i className="fa-solid fa-circle-check text-brand"></i> Tudo pronto, {name.split(' ')[0] || 'Linda'}!</h4>
